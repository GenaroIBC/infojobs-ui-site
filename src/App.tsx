        ...
        <aside className="md:col-span-1 py-4 md:sticky md:h-screen top-0 bg-slate-700">
          <div className="font-extrabold flex items-center gap-2 mt-4 mb-6 p-4 justify-center">
            <img
              ...
              height={32}
            />
            <span className="text-3xl bg-clip-text bg-gradient-to-r from-cyan-500 to-fuchsia-600 text-transparent">
              Infojobs UI
            </span>
          </div>
        ...
        <main className="p-4 md:col-span-3 mt-12">
          <h1 className="font-extrabold flex items-center gap-2">
            <img
              ...
              height={48}
            />
            <span className="bg-clip-text bg-gradient-to-r from-cyan-500 to-fuchsia-600 text-transparent">
              Infojobs UI
            </span>
          </h1>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <p>
                          ...
                          elit. Expedita ad, quod eaque qui vel quae iure
                          maiores accusantium alias pariatur!
                        </p>
                ...
                },
                {
                  element: (
                    <div className="flex flex-col gap-2">
                      ...
                      <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing
                        elit. Porro sit soluta eligendi, officiis non voluptatum
                      ...
                      <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Optio aperiam a molestiae consequuntur cupiditate
                        debitis doloribus iure tenetur inventore maxime! Beatae
                        deleniti enim et nemo quae odio adipisci dicta
